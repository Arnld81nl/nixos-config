...
## What Works
1. `~/.local/bin/vpn-toggle 1` - works from terminal
2. `~/.local/bin/vpn-status-1` - returns correct JSON
...
2. Added environment vars to wrapper scripts (vpn-1, vpn-2, vpn-3) - didn't help
...
{
    "id": "CustomButton",
    "textCommand": "~/.local/bin/vpn-status-1",
    "leftClickExec": "~/.local/bin/vpn-1",
    "parseJson": true,
    "textIntervalMs": 2000,
...
- VPN 1:0.0.0.0:10443 (working)
- VPN 2:0.0.0.0:443 (working)
- VPN 3: 0.0.0.0:443 (needs separate certs - TODO later)
